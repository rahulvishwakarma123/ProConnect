          ...
          <div className={s.wrapper}>
            <div className={s.scrollContainer}>
              ...
              <div className={s.createPostContainer}>
                ...
                <img className={s.userProfilePicture} src={`${BASE_URL}/${authState.user.userId.profilePicture}`} alt="" />

                <textarea onChange={(e) => {
                  setPostMeassage(e.target.value)
                }}
                  value={postMeassage}
                  className={s.postMeassage} name="message" id="message" placeholder={`What's in your mind?`}></textarea>


                <label htmlFor="fileUpload">
                  <div className={s.fileActionButton}>
                ...
                {postMeassage.length > 0 && <div onClick={() => {
                  handlePost()
                }} className={s.submitPost}>
                  Upload Post
                </div>}
            ...
            <div className={s.postContainer}>
              ...
              {postState.posts.map((post) => {
                return (
                  <div key={post._id} className={s.singleCard}>
                    <div className={s.singleCard__profileContainer}>
                      <img src={`${BASE_URL}/${post.userId.profilePicture}`} alt="Profile Picture" />
                      <div>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                          ...
                          {post.userId._id === authState.user.userId._id &&
                            ...
                            }} style={{ width: '1.3rem', color: 'red', cursor: 'pointer' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        ...
                        <div className={s.singleCard__image}>
                          {
                            post.image !== ''? <img src={`${BASE_URL}/${post.media}`} alt="content Image" /> : null
                          }
                        </div>
